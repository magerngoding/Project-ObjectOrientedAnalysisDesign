        ...
        if (data[i].parent_comment == 0) {
          ...
          for (var r = 0; r < data.length; r++) {
            if (data[r].parent_comment == commentId) {
              var comments = $(
                '<tr><td style="padding-left:80px"><b><img src="avatar.jpg" width="30px" height="30px" />' + data[r].student + " :<i> " + data[r].date + ':</i></b></br><p style="padding-left:40px">' + data[r].post + "</p></td></tr>"
              );
